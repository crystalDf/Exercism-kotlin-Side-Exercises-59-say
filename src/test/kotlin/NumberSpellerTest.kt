...
class NumberSpellerTest {
    ...
    @Test
    fun `10 as ten`() = 10.shouldSoundLike("ten")

    @Test
    fun `101 as one hundred one`() = 101.shouldSoundLike("one hundred one")

//    @Test
//    fun `1000000000000 as one trillion`() = 1000000000000.shouldSoundLike("one trillion")
}
